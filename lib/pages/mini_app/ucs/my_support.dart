                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        bottom: 0, top: 0),
                                    child: Text(
                                      "Requesting road barrier for road closure",
                                      style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 14,
                                        color: Theme.of(context)
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        bottom: 0, top: 0),
                                    child: Text(
                                      "Control/Audio Room Booking for Seminar Room 7/8",
                                      style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 14,
                                        color: Theme.of(context)
                                ...
                                children: [
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.only(
                                        bottom: 0, top: 0),
                                    child: Text(
                                      "OWeek Facilitators Area Air Conditioner",
                                      style: TextStyle(
                                        fontWeight: FontWeight.w400,
                                        fontSize: 14,
                                        color: Theme.of(context)
